...
type Kubernetes struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.masterVswitchIds) || (has(self.initProvider) && has(self.initProvider.masterVswitchIds))",message="spec.forProvider.masterVswitchIds is a required parameter"
