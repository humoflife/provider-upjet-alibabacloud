...
type GroupPolicyAttachmentObservation struct {
	...
	// The attachment ID. Composed of policy name, policy type and group name with format group:<policy_name>:<policy_type>:<group_name>.
...
// GroupPolicyAttachment is the Schema for the GroupPolicyAttachments API. Provides a RAM Group Policy attachment resource.
