...
type UserPolicyAttachmentObservation struct {
	...
	// The attachment ID. Composed of policy name, policy type and user name with format user:<policy_name>:<policy_type>:<user_name>.
...
// UserPolicyAttachment is the Schema for the UserPolicyAttachments API. Provides a RAM User Policy attachment resource.
