...
type NetworkInterfaceAttachment struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.networkInterfaceId) || (has(self.initProvider) && has(self.initProvider.networkInterfaceId))",message="spec.forProvider.networkInterfaceId is a required parameter"
