...
type AutoSnapshotPolicyAttachment struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.autoSnapshotPolicyId) || (has(self.initProvider) && has(self.initProvider.autoSnapshotPolicyId))",message="spec.forProvider.autoSnapshotPolicyId is a required parameter"
