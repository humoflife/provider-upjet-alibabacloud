...
type ImageCopy struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.sourceImageId) || (has(self.initProvider) && has(self.initProvider.sourceImageId))",message="spec.forProvider.sourceImageId is a required parameter"
