...
type DeploymentSetInitParameters struct {
	...
	// (Deprecated since v1.243.0) Field domain has been deprecated from provider version 1.243.0.
	Domain *string `json:"domain,omitempty" tf:"domain,omitempty"`

	// (Deprecated since v1.243.0) Field granularity has been deprecated from provider version 1.243.0.
