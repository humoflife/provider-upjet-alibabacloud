...
type TrafficMirrorFilterIngressRuleInitParameters struct {
...
type TrafficMirrorFilterIngressRuleObservation struct {
	...
	// The ID of the resource supplied above.The value is formulated as <traffic_mirror_filter_id>:<traffic_mirror_filter_ingress_rule_id>.
...
type TrafficMirrorFilterIngressRuleSpec struct {
	...
	// autoscaler.
	InitProvider TrafficMirrorFilterIngressRuleInitParameters `json:"initProvider,omitempty"`
}
...
// TrafficMirrorFilterIngressRule is the Schema for the TrafficMirrorFilterIngressRules API. Provides a Alicloud VPC Traffic Mirror Filter Ingress Rule resource.
