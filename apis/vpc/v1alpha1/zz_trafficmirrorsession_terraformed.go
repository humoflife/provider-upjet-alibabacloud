...
func (tr *TrafficMirrorSession) GetObservation() (map[string]any, error) {
...
func (tr *TrafficMirrorSession) SetObservation(obs map[string]any) error {
...
func (tr *TrafficMirrorSession) GetParameters() (map[string]any, error) {
...
func (tr *TrafficMirrorSession) SetParameters(params map[string]any) error {
...
// GetInitParameters of this TrafficMirrorSession
func (tr *TrafficMirrorSession) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TrafficMirrorSession
func (tr *TrafficMirrorSession) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
