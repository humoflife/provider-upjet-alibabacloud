...
type BucketLogging struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.targetBucket) || (has(self.initProvider) && has(self.initProvider.targetBucket))",message="spec.forProvider.targetBucket is a required parameter"
