...
func main() {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-oci-cloudmonitorservice",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_cloudmonitorservice(mgr, o), "Cannot setup OCI controllers")
