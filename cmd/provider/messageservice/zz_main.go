...
func main() {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-oci-messageservice",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_messageservice(mgr, o), "Cannot setup OCI controllers")
